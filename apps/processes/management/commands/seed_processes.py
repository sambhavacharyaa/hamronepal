...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        business_category, _ = ProcessCategory.objects.get_or_create(
            slug="business", defaults={"name": "Business", "name_ne": "व्यवसाय", "order": 1}
        )
        travel_category, _ = ProcessCategory.objects.get_or_create(
            slug="travel-documents",
            defaults={"name": "Travel & Documents", "name_ne": "यात्रा र कागजातहरू", "order": 2},
        )
    ...
    def _seed_company_registration(self, category, org, office, publisher):
        process, created = Process.objects.get_or_create(
            ...
            defaults={
                ...
                "title_ne": "प्राइभेट लिमिटेड कम्पनी दर्ता गर्नुहोस्",
                "category": category,
                ...
                "meta_title_ne": "नेपालमा प्राइभेट लिमिटेड कम्पनी कसरी दर्ता गर्ने",
                "meta_description": (
        ...
        ProcessStep.objects.create(
            ...
            fee_note_ne="NPR १,००० (१ लाखसम्मको पूँजी) देखि ठूला प्राइभेट कम्पनीका लागि NPR ४३,०००+ सम्म।",
        )
        ProcessStep.objects.create(
            process=process, order=5, title="Receive the certificate of incorporation",
            title_ne="स्थापना प्रमाणपत्र प्राप्त गर्नुहोस्",
            description="Once verified, OCR issues the certificate of incorporation electronically through CAMIS.",
            description_ne="प्रमाणित भएपछि, OCR ले CAMIS मार्फत विद्युतीय रूपमा स्थापना प्रमाणपत्र जारी गर्छ।",
        )

        ProcessRequirement.objects.create(
            process=process, order=1, name="Promoters' citizenship certificates",
            name_ne="प्रवर्द्धकहरूको नागरिकता प्रमाणपत्र",
            ...
            description_ne="प्रत्येक प्रवर्द्धकको नागरिकता प्रमाणपत्रको प्रतिलिपि (वा संस्थागत/विदेशी प्रवर्द्धकको लागि कम्पनी दर्ता प्रमाणपत्र/राहदानी)।",
        )
        ProcessRequirement.objects.create(
            process=process, order=2, name="Memorandum of Association (MOA)", name_ne="प्रबन्धपत्र (MOA)"
        )
        ProcessRequirement.objects.create(
            process=process, order=3, name="Articles of Association (AOA)", name_ne="नियमावली (AOA)"
        )
        ProcessRequirement.objects.create(
            process=process, order=4, name="Reserved company name approval", name_ne="आरक्षित कम्पनी नाम स्वीकृति"
        )
        ProcessRequirement.objects.create(
            process=process, order=5, name="Registered office address proof",
            name_ne="दर्ता कार्यालयको ठेगाना प्रमाण", is_mandatory=False,
        )

        ProcessFAQ.objects.create(
            process=process, order=1,
            question="Do I need to visit the OCR office in person?",
            question_ne="के मैले OCR कार्यालयमा स्वयं जानुपर्छ?",
            answer=(
        ...
        ProcessFAQ.objects.create(
            ...
            question_ne="दर्ता शुल्क कसरी गणना गरिन्छ?",
            answer=(
    ...
    def _seed_pan_registration(self, category, org, office, publisher):
        process, created = Process.objects.get_or_create(
            ...
            defaults={
                ...
                "title_ne": "PAN (स्थायी लेखा नम्बर) को लागि दर्ता गर्नुहोस्",
                "category": category,
                "responsible_organization": org,
                "summary": (
                ...
                "total_fee_note_ne": "निःशुल्क - कुनै दर्ता शुल्क लाग्दैन।",
                "meta_title": "How to Register for a PAN in Nepal",
                "meta_title_ne": "नेपालमा PAN को लागि कसरी दर्ता गर्ने",
                "meta_description": (
        ...
        ProcessStep.objects.create(
            ...
            title_ne="अनलाइन आवेदन दिनुहोस्",
        ...
        ProcessFAQ.objects.create(
            ...
            question_ne="PAN दर्ताको लागि शुल्क लाग्छ?",
            answer="No - PAN registration is free of charge.",
            answer_ne="छैन - PAN दर्ता निःशुल्क छ।",
        )
        ProcessFAQ.objects.create(
            process=process, order=2,
            question="Do I need to visit an IRD office?",
            question_ne="मैले IRD कार्यालयमा जानुपर्छ?",
            answer=(
    ...
    def _seed_passport(self, category, org, office, publisher):
        process, created = Process.objects.get_or_create(
            ...
            defaults={
                ...
                "title_ne": "नेपाली राहदानीको लागि आवेदन दिनुहोस्",
                "category": category,
                "responsible_organization": org,
                "summary": (
                ...
                "meta_title_ne": "नेपाली राहदानीको लागि कसरी आवेदन दिने",
                "meta_description": (
        ...
        ProcessStep.objects.create(
            ...
            title_ne="अनलाइन पूर्व-दर्ता पूरा गर्नुहोस्",
            ...
            description_ne="आफ्नो नागरिकता नम्बर र मोबाइल नम्बर प्रयोग गरी nepalpassport.gov.np मा खाता बनाई पूर्व-दर्ता पूरा गर्नुहोस्।",
        )
        ProcessStep.objects.create(
            process=process, order=2, title="Visit a District Administration Office or the Department HQ",
            title_ne="जिल्ला प्रशासन कार्यालय वा विभागको मुख्यालय जानुहोस्",
            description=(
        ...
        ProcessStep.objects.create(
            ...
            title_ne="कागजात र बायोमेट्रिक पेश गर्नुहोस्",
            ...
            description_ne="आफ्नो मुद्रित पूर्व-दर्ता फारम, नागरिकता प्रमाणपत्र, र (नवीकरणको लागि) अघिल्लो राहदानी पेश गरी फोटो र बायोमेट्रिक खिच्ने काम पूरा गर्नुहोस्।",
        )
        ProcessStep.objects.create(
            process=process, order=4, title="Pay the passport fee",
            title_ne="राहदानी शुल्क बुझाउनुहोस्",
            ...
            description_ne="आफ्नो राहदानी प्रकार (पृष्ठ संख्या, नयाँ/नवीकरण वा हराएको/बिग्रेको) अनुसारको शुल्क कार्यालयमा वा बैंक भौचरमार्फत बुझाउनुहोस्।",
            fee_note="NPR 12,000-25,000 depending on page count, category, and whether it is new/renewal or a replacement.",
            fee_note_ne="पृष्ठ संख्या, वर्ग, र नयाँ/नवीकरण वा प्रतिस्थापन अनुसार NPR १२,०००-२५,०००।",
        )
        ProcessStep.objects.create(
            process=process, order=5, title="Collect your passport",
            title_ne="आफ्नो राहदानी बुझ्नुहोस्",
            description="Collect your passport once ready, or as instructed by the office (regular: 10-30 days; expedited: ~2 working days).",
            description_ne="तयार भएपछि वा कार्यालयले तोकेबमोजिम आफ्नो राहदानी बुझ्नुहोस् (नियमित: १०-३० दिन; द्रुत: लगभग २ कार्यदिन)।",
        )

        ProcessRequirement.objects.create(
            process=process, order=1, name="Citizenship certificate (original + photocopy)",
            name_ne="नागरिकता प्रमाणपत्र (सक्कल + प्रतिलिपि)",
        )
        ProcessRequirement.objects.create(
            process=process, order=2, name="Printed pre-enrollment form with barcode/QR code",
            name_ne="बारकोड/QR कोड सहितको मुद्रित पूर्व-दर्ता फारम",
        )
        ProcessRequirement.objects.create(
            process=process, order=3, name="Previous passport (photocopy)", name_ne="अघिल्लो राहदानी (प्रतिलिपि)",
            is_mandatory=False,
            description="Required for renewals only.", description_ne="नवीकरणका लागि मात्र आवश्यक।",
        )
        ProcessRequirement.objects.create(
            process=process, order=4, name="Both parents' citizenship certificates and marriage registration certificate",
            name_ne="दुवै अभिभावकको नागरिकता प्रमाणपत्र र विवाह दर्ता प्रमाणपत्र",
            is_mandatory=False, description="Required for minor applicants only.",
            description_ne="नाबालक आवेदकका लागि मात्र आवश्यक।",
        )
        ProcessRequirement.objects.create(
            process=process, order=5, name="Payment receipt / bank voucher",
            name_ne="भुक्तानी रसिद / बैंक भौचर",
        )

        ProcessFAQ.objects.create(
            process=process, order=1,
            question="How much does a Nepali passport cost?",
            question_ne="नेपाली राहदानीको मूल्य कति हो?",
            answer=(
        ...
        ProcessFAQ.objects.create(
            ...
            question_ne="यसमा कति समय लाग्छ?",
            answer=(
